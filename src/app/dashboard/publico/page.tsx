    ...
    <main className="w-screen h-screen relative">
      ...
      <Tabs defaultValue="inicio" className="w-full h-full flex flex-row">
        ...
        {openMenu && (
          ...
          >
            <Button className="absolute top-4 text-3xl" variant="secondary">
            ...
            {/*LOGOUT*/}
            <TabsTrigger value="logout" className="w-full flex py-3">
              <div className="w-[40%]">
                <CiLogout size={20} />
              </div>
        ...
        >
          ...
          {/*CONTA*/}
          <Conta email="publico@gmail.com"  nome="pulico" sem_matricula={true} />
